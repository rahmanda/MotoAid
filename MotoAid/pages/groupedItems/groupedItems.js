(function () {
    ...
    ui.Pages.define("/pages/groupedItems/groupedItems.html", {
        ...
        ready: function (element, options) {
            if (!Data.loadSetting) {
                var msg = new Windows.UI.Popups.MessageDialog("Please choose your motor first", "Choose motor"); msg.showAsync();
            }
        ...
        _itemInvoked: function (args) {
            if (appView.value === appViewState.snapped) {
                ...
                //var msg = new Windows.UI.Popups.MessageDialog(args.detail.itemIndex, "Read From File"); msg.showAsync();
