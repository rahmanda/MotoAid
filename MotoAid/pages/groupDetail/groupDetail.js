    ...
    ui.Pages.define("/pages/groupDetail/groupDetail.html", {
        ...
        updateLayout: function (element, viewState, lastViewState) {
            ...
            if (lastViewState !== viewState) {
                if (lastViewState === appViewState.snapped || viewState === appViewState.snapped || lastViewState === appViewState.fullScreenPotrait || viewState === appViewState.fullScreenPortrait) {
        ...
        _itemInvoked: function (args) {
            ...
            WinJS.Navigation.navigate("/pages/itemDetail/itemDetail.html", { item: Data.getItemReference(item), index: args.detail.itemIndex });
        }
    });
})();
