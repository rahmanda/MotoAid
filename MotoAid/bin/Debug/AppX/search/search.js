...
(function () {
    ...
    var searchPageURI = "/search/search.html";
    ...
    ui.Pages.define(searchPageURI, {
        ...
        // This function colors the search term. Referenced in /search/search.html
        ...
        _searchData: function (queryText) {
            ...
            if (window.Data) {
                originalResults = Data.items.createFiltered(function (item) {
                    return (item.title.indexOf(queryText) >= 0 || item.specs.indexOf(queryText) >= 0);
                });
            } else {
